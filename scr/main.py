...
# idk --> zip ??
feature_names = model.named_steps['polynomialfeatures'].get_feature_names_out(X_train.columns)
...
joblib.dump(model, 'LinearRegression(Ridge_alpha=1,degree=3,R=0.5968).pkl')
